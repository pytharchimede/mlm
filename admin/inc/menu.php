    ...
    <nav class="bg-gray-900 text-white px-4 py-3 shadow-lg flex justify-between items-center">
        <a href="dashboard.php" class="text-2xl font-bold">Dashboard Admin</a>
    ...
    <div id="sidebar" class="md:flex hidden justify-center space-x-8 bg-gray-900 py-3 text-white">
        ...
        <a href="emails_log.php" class="hover:bg-gray-700 p-2 rounded-md"><i class="fas fa-paper-plane mr-2"></i>Emails envoyés</a>
        <a href="#" class="hover:bg-gray-700 p-2 rounded-md"><i class="fas fa-users mr-2"></i>Utilisateurs</a>
        <a href="details_visites.php" class="hover:bg-gray-700 p-2 rounded-md">
            <i class="fas fa-map-marker-alt mr-2"></i>Visites
        </a>
    </div>